"use strict"
// روی این آرایه حلقه یزنی و لست نیم همه را لاگ بگیری
...
//     let lastName= footballPlayers[i].lastName;
//     console.log(lastName)
//   }
// -------------------------------------------------------------------------------

//فقط اونایی که شمارشون از 8 یسشتر هست را لست نیم آنرا برگرداند
// const footballPlayers = [{
//         name: "Lionel",
//         lastName: "Messi",
//         number: "10"
...
//یک سن مثلا 25 را میدهیم و میخواهیم تمام بازیکنانی که سن آنها از 25 بیشتر است را برگرداند
// const footballPlayers = [
//     {
//       name: "Lionel",
//       lastName: "Messi",
...
//    return result;
// };
// console.log(olderThan(25));
// -------------------------------------------------------------------------------------


//اسم کشور را بدهیم و لیست تمام بازیکنان آن کشور را برگرداند
// const footballPlayers = [{
//         name: "Lionel",
//         lastName: "Messi",
//         number: "10",
...
//     }
// ]
// function identifyNationality(nationality) {
//     const arr = [];
//     for (let player of footballPlayers) {
...
//     return arr;
// }
// console.log(identifyNationality("Argentina"));
